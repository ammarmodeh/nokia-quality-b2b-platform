...
const MonthlyReasonTable = ({ tasks }) => {
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Monthly Reason Summary');
    const fileName = `Monthly_Reason_Summary_${periodLabel}_${new Date().toISOString().slice(0, 10)}.xlsx`;
    ...
    <Box sx={{ my: 4 }}>
      ...
      {selectedRowData && (
        <ViolationDetailsDialog
          ...
          teamName={selectedRowData.reason} // Passing reason as teamName specifically for this dialog reuse
...
export default MonthlyReasonTable;
